...
const LegacyWdcPromisesPage = ({
  data,
  location,
}: PageProps<Queries.WdcPromisesQuery>) => {
  ...
  $.getJSON('https://api.example.com?page=' + pageNumber, function (response) {
    ...
    tableau.dataCallback(response.records, pageNumber, hasMoreData);
          ...
          <div className="kg-card kg-image-card kg-width-full">
            <GatsbyImage
              image={imageOf(data.waterfallSync)!}
              className="kg-image"
...
console.log('First: No data yet!');`}</code>
          ...
          <div className="kg-card kg-image-card kg-width-full">
            <GatsbyImage
              image={imageOf(data.waterfallAsync)!}
              className="kg-image"
...
export const Head = ({ data }: HeadProps<Queries.WdcPromisesQuery>) => {
