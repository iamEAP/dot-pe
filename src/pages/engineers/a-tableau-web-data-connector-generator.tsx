...
import { graphql, withPrefix, type HeadProps, type PageProps } from "gatsby"
...
const LegacyWdcGeneratorPage = ({
  data,
  location,
}: PageProps<Queries.WdcGeneratorQuery>) => {
      ...
      <article className="post-content page-template no-image">
        ...
        <div className="post-content-body">
          <div className="kg-card kg-image-card kg-width-full">
            <GatsbyImage
              image={imageOf(data.yoTableauDataConnector)!}
              className="kg-image"
          ...
          <hr />
          <GatsbyImage
            image={imageOf(data.wdcConnectionWindow)!}
            className="kg-image"
