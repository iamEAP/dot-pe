...
const StaticSou20251ResponsePage = ({
  data,
  location,
}: PageProps<Queries.SouResponseEnQuery>) => {
  const siteTitle = data.site?.siteMetadata?.title ?? ""
  const flagImage = imageOf(data.svenskaFlaggan)
...
export const Head = ({ data }: HeadProps<Queries.SouResponseEnQuery>) => {
